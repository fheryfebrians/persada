                    ...
                    <div class="x_panel">
                        <div class="row">
                            ...
                            <div class="col-md-12  col-sm-8 ptp10">
                                ...
                                <form class="form-horizontal form-label-left" name="frmBlogPost" id="frmBlogPost" action="{{ url('admin/profile/update/1') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PATCH')
                                    <div class="item form-group">
                                        <div class="col-md-12 col-sm-6 col-xs-12">
                                            <textarea name="profile" id="profile" cols="100" rows="20"></textarea>
                                        </div>
                                    </div>
