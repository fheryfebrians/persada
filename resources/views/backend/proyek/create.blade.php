...
@section('pageTitle', 'Add New Proyek')
...
<div class="clearfix midpart">
	<div class="row">
		<div class="col-sm-12 col-md-12">
			<div class="maintitle">
				<h3 class="topspace">Add New Proyek</h3>
			</div>
			...
			<div class="x_panel">
				<div class="row">
					...
					<div class="col-md-12  col-sm-12 ptp10">
						...
						<form class="form-horizontal form-label-left" name="frmBlogPost" id="formPost" action="{{ url('admin/proyek/create') }}" method="post" enctype="multipart/form-data">
							@csrf
                            ...
                            <div class="item form-group">
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									<textarea name="keterangan" id="proyek" class="form-control"></textarea>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="col-sm-6 col-sm-offset-4 col-md-6 col-md-offset-4">
									...
									<button type="button" class="btn btn-primary" onclick="location.href='{{ url('admin/proyek')}}'">Cancel</button>
								</div>
							</div>
