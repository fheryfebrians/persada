...
<div class="clearfix midpart">
	<div class="row">
		<div class="col-sm-12 col-md-12">
			<div class="maintitle">
				<h3 class="topspace">Tentang Tim Produksi</h3>
            </div>
                                ...
                                <td class="nopaddingtd">
                                    <table id="example" class="table table-striped responsive-utilities jambo_table table-bordered">
                                        ...
                                        @foreach ($produksis as $produksi)
                                            <tbody>
                                                <tr>
                                                    <td class="p20">{!! $produksi->description !!}</td>
                                                    <td>
                                                        <form action="{{ url('admin/tentang/produksi/delete', $produksi->id) }}" method="post">
                                                            @csrf
                    ...
                    <div class="x_panel">
                        <div class="row">
                            ...
                            <div class="col-md-12  ptp10">
                                ...
                                <form class="form-horizontal form-label-left" name="frmBlogPost" id="formPost" action="{{ url('admin/tentang/produksi/create') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-12 col-sm-6 col-xs-12">
                                            ...
                                            <textarea name="description" id="produksi"></textarea>
                                        </div>
                                    </div>
