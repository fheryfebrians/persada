...
<div class="clearfix midpart">
	<div class="row">
		<div class="col-sm-12 col-md-12">
			<div class="maintitle">
				<h3 class="topspace">Tentang Tim Tulangan</h3>
            </div>
                    ...
                    <div class="x_panel">
                        <div class="row">
                            ...
                            <div class="col-md-12  ptp10">
                                ...
                                <form class="form-horizontal form-label-left" name="frmBlogPost" id="formPost" action="{{ url('admin/tentang/tulangan/create') }}" method="post" enctype="multipart/form-data">
                                    @csrf
