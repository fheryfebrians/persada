            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="../index.html">Home</a><i class="fa fa-angle-double-right"></i><span>Tentang Tim Utilitas Pabrik</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="text-container last">
                        <h3>Tim Utilitas Pabrik</h3>
                        @foreach ($utpabrik as $ut)
                            <p>{!! $ut->description !!}</p><br>
                        @endforeach
